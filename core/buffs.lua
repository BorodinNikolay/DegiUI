  ...
  local function applySkin(b)
    ...
    --border
    if DegiUIOptions.buffborder then
  ...
  borderFrame:GetRegions():SetVertexColor(0.05,0.05,0.05)
  TotemFrameTotem1Duration:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
  TotemFrameTotem1Duration:AdjustPointsOffset(0,3)
  
  local iconFrame, borderFrame = TotemFrameTotem2:GetChildren()
  borderFrame:GetRegions():SetVertexColor(0.05,0.05,0.05)
  TotemFrameTotem2Duration:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
  TotemFrameTotem2Duration:AdjustPointsOffset(0,3)
  
  local iconFrame, borderFrame = TotemFrameTotem3:GetChildren()
  borderFrame:GetRegions():SetVertexColor(0.05,0.05,0.05)
  TotemFrameTotem3Duration:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
  TotemFrameTotem3Duration:AdjustPointsOffset(0,3)
  
  local iconFrame, borderFrame = TotemFrameTotem4:GetChildren()
  borderFrame:GetRegions():SetVertexColor(0.05,0.05,0.05)
  TotemFrameTotem4Duration:SetFont("Fonts\\FRIZQT__.TTF", 12, "OUTLINE")
  TotemFrameTotem4Duration:AdjustPointsOffset(0,3)